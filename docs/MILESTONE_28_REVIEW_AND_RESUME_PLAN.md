...
| M28-CN9 | One next-ranked compatibility family | Ready (`FlowDefinitionView.VersionNumber` standard-schema field, affecting 1,121 tests) | CENSUS-9 complete | Standard schema and query typing |
