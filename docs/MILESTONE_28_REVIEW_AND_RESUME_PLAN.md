...
| M28-M2B | Database, schema, and SQLite maintainability restoration | Active (`codex/m28-m2b-database-schema`) | M2A integrated at `a1c5141` | Platform database/schema/SQLite |
