...
| M28-CN11 | One next-ranked compatibility family | Active on `codex/m28-cn11-dynamic-query-cast` (`List<SObject>`-to-`Log__c` cast diagnostic, affecting 1,121 tests) | CENSUS-11 complete | Semantic cast typing |
