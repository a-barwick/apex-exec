...
| M28-M3B | Runtime collection dispatch restoration | Active (`codex/m28-m3b-runtime-collections`; `/root/m28_m3b_collections`) | M3A integrated at `247db5c` | Runtime List/Set/Map intrinsics |
