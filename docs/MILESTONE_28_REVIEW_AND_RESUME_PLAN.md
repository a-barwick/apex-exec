...
| M28-CN14 | One next-ranked compatibility family | Ready (`Approval.ProcessResult`, affecting 1,005 tests) | CENSUS-14 complete | Approval process result type and value surface |
