...
| M28-CN12 | One next-ranked compatibility family | Active on `codex/m28-cn12-single-email-message` (`Messaging.SingleEmailMessage`, affecting 1,117 tests) | CENSUS-12 complete | Messaging email platform surface |
