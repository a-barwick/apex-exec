...
| M28-M2A | Metadata import maintainability restoration | Active (`codex/m28-m2a-metadata`; claimed from reviewed integration baseline `7ab1434`) | M1 integrated at `e044cea` | Platform metadata |
