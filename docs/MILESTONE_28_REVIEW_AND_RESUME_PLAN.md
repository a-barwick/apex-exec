...
| M28-CN10 | One next-ranked compatibility family | Active on `codex/m28-cn10-flow-definition-active` (`FlowDefinitionView.IsActive` standard-schema field, affecting 1,121 tests) | CENSUS-10 complete | Standard schema and query typing |
