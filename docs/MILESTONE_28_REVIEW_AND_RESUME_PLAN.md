...
| M28-Q4A | AST and SObject error-shape Clippy cleanup | Review (`84fa90f`; format/check/full Rust pass; 10 owned Clippy diagnostics removed, leaving Q4B=15 and Q4C=3) | Q3 integrated at `aa82776f` | AST, platform SObject |
