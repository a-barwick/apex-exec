...
| M28-V0 | Integrated quality-gate checkpoint | Review (`ba92a42`; owner-authorized website dependency recovery; Rust fmt/test/North Star/Clippy, tooling, docs, actionlint, whitespace, Lizard, website, editor, npm policy, pinned `cargo-audit` 0.22.2, and fresh full LLVM coverage pass; `cargo-deny` is not locally/prebuilt available and source installation is explicitly out of scope) | Q1-Q4C, M1-M5B | Verification and documentation |
