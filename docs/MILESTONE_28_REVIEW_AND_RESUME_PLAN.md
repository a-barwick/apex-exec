...
| M28-M4 | Runtime platform dispatch decomposition | Review (`8419a40`; Rust 1.88 fmt/check/full-test/Clippy and documentation validation pass; Lizard clears all M4 debt and reports exactly 16 downstream M5A/M5B debts) | M3C integrated at `ae85601` | `runtime/platform_intrinsics.rs` |
