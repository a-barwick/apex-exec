...
| M28-CN8 | One next-ranked compatibility family | Ready (`User.IsActive` Boolean standard-schema field, affecting 1,121 tests) | CENSUS-8 complete | Standard schema and query typing |
