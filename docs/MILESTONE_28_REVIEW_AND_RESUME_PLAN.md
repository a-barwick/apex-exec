...
|---|---|---|---|---|
| M28-Q1 | Semantic receiver and profile correctness | Review (`5634c4f`; focused/filtered verification passes; full gates remain blocked by Q2/Q3/Q4) | Recorded review | `semantic.rs`, focused semantic/M10/M25 tests |
