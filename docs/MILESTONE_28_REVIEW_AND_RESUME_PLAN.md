...
| M28-CN6 | One next-ranked compatibility family | Active on `codex/m28-cn6-generated-share-sobjects` (generated custom-share SObject resolution for `Log__Share`; claimed from integrated census checkpoint `103864e`) | CENSUS-6 complete | Normalized schema and typed generated-share SObject surface |
